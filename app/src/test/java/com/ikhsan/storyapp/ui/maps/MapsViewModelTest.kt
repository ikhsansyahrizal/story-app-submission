...
class MapsViewModelTest {
    ...
    private val sut = MapsViewModel(storyUseCase)
    ...
    fun `when Get Story Should Not Null and Return Data`() = runTest {
        ...
        every {
            storyUseCase.getAllStoriesWithLocation()
        } returns expectedStory

        val actualStory: PagingData<ListStory> = sut.getAllStories().getOrAwaitValue()
